...
public class Level_6_data_table extends BaseTest{
...
//		Assert.assertTrue(homePage.isPageNumberActive("10"));
		// thao tac o 1 o bat ki, dua vao thu tu cua cot, thu tu cua hang, giao giua hang voi cot la o minh can
		// nhap lieu vao o tai cot Contact Person hang 2
		// làm sao để láy ra được thứ tự của cột khi biết trước tên cột
		// nhập liệu vào
		//tr[2]/td[3]
		homePage.enterToTextBoxByHeaderNameAndRowNumber("Contact Person", "2", "Automation FC");
		homePage.sleepInSecond(3);
		homePage.enterToTextBoxByHeaderNameAndRowNumber("Company", "1", "Viet dung");
		homePage.sleepInSecond(3);
	}
